...
<head>
    ...
    <style>
        ...
        .alert-success { background-color: rgba(74, 222, 128, 0.2); border: 1px solid #4ade80; color: #4ade80; }
        .alert-danger { background-color: rgba(255, 71, 71, 0.2); border: 1px solid #ff4747; color: #ff4747; }
    </style>
</head>
<body>
    ...
    <div class="public-container">
        ...
        <p style="text-align: center; color: #94a3b8; margin-bottom: 25px;">Crea una nueva clase para luego asignarle horarios recurrentes.</p>
        ...
        <form action="{{ route('clases.store') }}" method="POST">
            ...
            <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                <div style="flex: 1; min-width: 150px;">
                    <label style="color: var(--neon-blue); font-size: 0.85rem;">Materia</label>
                    <input type="text" name="materia" class="neon-input" required>
                </div>
                <div style="flex: 1; min-width: 150px;">
                    <label style="color: var(--neon-blue); font-size: 0.85rem;">Grupo</label>
            ...
            <button type="submit" class="btn-action-green">CREAR CLASE</button>
        </form>

        <div style="margin-top: 20px; text-align: center;">
            <a href="{{ route('clases.index') }}" style="color: var(--neon-blue); text-decoration: none;">← Volver al listado</a>
        </div>
    </div>
